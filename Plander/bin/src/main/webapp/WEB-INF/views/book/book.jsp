...
$.ajax({
	...
	success: function(result){
		...
		ticket += numberWithCommas(ticket2w)+ "원 (사물함 선택 시 +2,000원)</td>";
		ticket += "</tr><tr><th>정기권 1개월</th><td>";
		ticket += numberWithCommas(ticketMon)+ "원 (사물함 제공)</td>";
		ticket += "</tr><tr><th>야간권(22:00 ~ 다음날 8:00)</th><td>";
		ticket += numberWithCommas(ticketNight)+ "원</td></tr>";
		$("#ticket").html(ticket);
		
		var price = "";
		price += "<tr>\<td>평일 8:00 ~ 18:00</td><td class='center'>1시간 "+ numberWithCommas(privateAm)+ "원</td>";
		price += "<td class='center'>1시간 "+ numberWithCommas(lab4Am)+"원</td>";
		price += "<td class='center'>1시간 "+ numberWithCommas(lab8Am)+ "원</td>";
		price += "<td class='center'>1시간 "+ numberWithCommas(lab12Am)+ "원</td>";
		price += "</tr><tr><td>평일 18:00 ~ 22:00</td><td class='center'>1시간 "+ numberWithCommas(privatePm)+ "원</td>";
		price += "<td class='center'>1시간 "+ numberWithCommas(lab4Pm)+ "원</td>";
		price += "<td class='center'>1시간 "+ numberWithCommas(lab8Pm)+ "원</td>";
		price += "<td class='center'>1시간 "+ numberWithCommas(lab12Pm)+ "원</td>";
		price += "</tr><tr><td>심야 22:00 ~ 다음날 8:00</td><td class='center'>1시간 "+ numberWithCommas(privateNight)+ "원</td>";
		price += "<td class='center'>1시간 "+ numberWithCommas(lab4Night)+ "원</td>";
		price += "<td class='center'>1시간 "+ numberWithCommas(lab8Night)+ "원</td>";
		price += "<td class='center'>1시간 "+ numberWithCommas(lab12Night)+ "원</td>";
		price += "</tr><tr><td>주말(토,일)</td><td class='center'>1시간 "+ numberWithCommas(privateHoliday)+ "원</td>";
		price += "<td class='center'>1시간 "+ numberWithCommas(lab4Holiday)+ "원</td>";
		price += "<td class='center'>1시간 "+ numberWithCommas(lab8Holiday)+ "원</td>";
		price += "<td class='center'>1시간 "+ numberWithCommas(lab12Holiday)+ "원</td></tr>";
