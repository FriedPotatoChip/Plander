...
public class BookController {
	...
	// 결제 페이지
	@RequestMapping("/pay")
	public String pay(BookingVO bvo, BookingCbVO cb_bvo, Model model, UsersVO uservo, SeatsVO svo,
			HttpServletRequest request, CabinetVO cvo) {
	...
	public String bookOk(HttpServletRequest request, BookingVO bvo, BookingCbVO cb_bvo, Model model, UsersVO uservo) {
		...
		String chkLen = request.getParameter("chkLen");
		System.out.println("test: " + test);
		System.out.println("test: " + chkLen);
