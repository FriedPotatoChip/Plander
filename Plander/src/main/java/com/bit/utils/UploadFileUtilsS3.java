...
public class UploadFileUtilsS3 {
	...
	public static String uploadFile(String uploadPath, String originalName, byte[] byteData) throws Exception {
		...
		String bucketName = "turtlesmiraclebucket";
		//랜덤의 uid 를 만들어준다.
...
//		s3.fileUpload(bucketName, new File(fileName))
	...
	public static String uploadProfileImg(String uploadPath, String originalName, byte[] byteData) throws Exception {
		...
		//savedName : 570d570a-7af1-4afe-8ed5-391d660084b7_g.JPG 같은 형식으로 만들어준다.
		String savedName = "/pro_"+uid.toString() + "_" + originalName;
