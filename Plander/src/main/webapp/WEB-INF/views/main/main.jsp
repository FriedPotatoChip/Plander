...
<body>
	...
	<div id="slides" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			...
			<div class="carousel-item">
				<img src="/resources/images/m0.jpg">
				<div class="carousel-caption">
					<h1>24시간 스터디 카페, 거북이의 기적입니다.</h1>
					<h3>스터디 모집 & 스터디룸 또는 좌석 예약을 도와드립니다.</h3>
				</div>
	...
	<div class="jumbotron jumbotron-fluid py-3">
		<div class="row mt-3 mb-5 py-3">
			...
			<div class="col py-3">
				...
				<a href="/TMS/book"><button type="button" class="btn centered"
	...
	<div class="container-fluid padding">
		<div class="row welcome text-center">
			...
			<hr>
			<div class="col-12">
				<p style="font-size: 18px;">어떻게 맨날 쓸모있는 일만 하고 사나요?
					&nbsp;&nbsp;&nbsp; "느려도 괜찮아!"</p>
			</div>
		</div>
	</div>
	...
	<div class="container-fluid padding" style="width: 90%;">
		<div class="row text-center padding">
			<div class="col-xs-12 col-sm-6 col-md-4">
				<img src="/resources/images/mainlogo.png" alt="logo" width="140px"
					height="auto">
				<h4 class="normal mt-2">종로점</h4>
				<p>
					서울특별시 종로구 종로 69 YMCA빌딩 7층 <br> (서울특별시 종로구 종로2가 9 YMCA빌딩 7층)
				</p>
				<p class="bold">02-722-1481</p>
			</div>
			<div class="col-xs-12 col-sm-6 col-md-4">
				<img src="/resources/images/mainlogo.png" alt="logo" width="140px"
					height="auto">
				<h4 class="normal mt-2">신촌점</h4>
				<p>
					서울 서대문구 연세로5나길 8 <br> (서울 서대문구 창천동 57-23)
				</p>
				<p class="bold">010-4434-1507</p>
			</div>
			<div class="col-sm-12 col-md-4">
				<img src="/resources/images/mainlogo.png" alt="logo" width="140px"
					height="auto">
				<h4 class="normal mt-2">강남점</h4>
				<p>
					서울특별시 강남구 테헤란로5길 11 YBM빌딩 2층 <br> (서울특별시 강남구 역삼동 819-4 YBM빌딩
					2층)
				</p>
				<p class="bold">02-3453-5404</p>
			</div>
		</div>
	</div>
	...
	<div class="container-fluid padding" id="section1">
		<div class="row padding">
			<div class="col-lg-6">
				...
				<p>- &nbsp;거북이의 기적은 공부하기 좋은 곳을 찾는 사람이라면 누구든지 이용할 수 있는 24시간 프리미엄
					회원제 스터디카페입니다.</p>
				<p>- &nbsp;전문가의 손길을 거친 인테리어와 조용하지만 답답하지 않은 분위기는 공부하기에 더할 나위 없는
					환경을 제공합니다.</p>
				<p>- &nbsp;커피나 차를 마시는 카페가 아닌 공부를 하는 공간에 아메리카노와 차가 더해진 공간입니다. 일반
					스터디 카페에서 공부를 하게 되면 커피나 음료를 시켜야 그 공간을 이용할 수 있지만 거북이의 기적은 공부가 메인인
					공간입니다.</p>
				<br>
			</div>
			<div class="col-lg-6">
