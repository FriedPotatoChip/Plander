			...
			<td colspan="4">
				<ol class="paging">
					...
					<c:choose>
						...
						<c:otherwise>
							<li><a href="/TMS/mypage/comment2?cPage=${pvo.beginPage - 1 }">이전으로</a>
							</li>
						</c:otherwise>
					</c:choose>
					...
					<c:forEach var="k" begin="${pvo.beginPage }" end="${pvo.endPage }">
						<c:choose>
							...
							<c:otherwise>
								<li><a href="/TMS/mypage/comment2?cPage=${k }">${k }</a></li>
							</c:otherwise>
						</c:choose>
					</c:forEach>
					...
					<c:choose>
						...
						<%--사용가능(enable) --%>
						<c:otherwise>
							<li><a href="/TMS/mypage/comment2?cPage=${pvo.endPage + 1 }">다음으로</a></li>
						</c:otherwise>
					</c:choose>
				</ol>
			</td>
